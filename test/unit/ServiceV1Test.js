...
describe('ServiceV1Test ', function () {
    ...
    it('check ServiceV1 function and values', function () {
        ...
        var requestId = request.createSDSession(config.context, config.user, config.password, config.baseUrl + 'sdsession/action/create', responder1, null, null, true, true);
