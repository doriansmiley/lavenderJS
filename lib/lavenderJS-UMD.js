...
var AbstractHttpService = (function () {
    ...
    //stub for override
    AbstractHttpService.prototype.setRequestHeaders = function (header, value) {
    };
...
var XhrHttpService = (function (_super) {
    ...
    function XhrHttpService(async, notifyOnProgress) {
        ...
        var _this = _super.call(this) || this;
        _this.xhrRequest = new XMLHttpRequest();
        _this.async = async;
    ...
    XhrHttpService.prototype.setRequestHeaders = function (header, value) {
